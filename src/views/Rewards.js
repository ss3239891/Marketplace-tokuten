    ...
    return (
      <Container fluid className="main-content-container px-4">
       ...
       <h5 className="subtit">Live Rewards</h5>
        ...
        <Button style={{color:"rgba(0, 0, 0, 0.7)",backgroundColor:"white",borderRadius:"1rem",borderColor:"gray",position:"relative",right:window.innerWidth<768?"-56%":"-85%",fontWeight:"700",fontSize:window.innerWidth<768?"0.7rem":"1rem",marginTop:window.innerWidth<768?"30px":null}}><svg className="plus" width="12" height="12" viewBox="0 0 12 12" fill="none" xmlns="http://www.w3.org/2000/svg">
